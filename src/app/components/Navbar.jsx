  ...
  return (
    <>
      ...
      <ul
        className={
          !nav
            ? 'absolute w-full h-screen bottom-[100%] flex flex-col p-4 justify-center items-start md:max-w-[13rem] text-gray-800 duration-500 z-50 uppercase'
            : `fixed w-full h-screen left-0 bottom-0 flex flex-col uppercase ${
                isBgBlack ? 'text-white' : 'text-white'
              } justify-center items-start md:max-w-[13rem] 2xl:max-w-[20rem] tracking-widest bg-black/90 p-4 z-50 duration-500`
        }
      >
        <ul
