...
import { Poppins, Montserrat, Kaushan_Script, Dekko } from 'next/font/google';
...
The internship under Ar. Ashiesh Shah during a year drop in 2007 carved a path for his career, setting a clear direction toward his goals & dreams.`;
  ...
  return (
    <div
      ...
      } items-start gap-6 py-6 px-4 md:px-8 max-w-4xl bg-black rounded-xl shadow-xl transition-transform duration-300 hover:scale-105`}
    >
      ...
      <div className='flex-1 space-y-4'>
        ...
        <div className='relative inline-block'>
          ...
          <h2
            className='text-2xl md:text-3xl lg:text-4xl font-bold uppercase tracking-wider title name-content'
        ...
        <h6
          className={`text-sm font-medium italic uppercase tracking-widest text-orange-400 name-content ${newFont.className}`}
